...
## Adding Custom Backup Types

docker-backup uses a plugin architecture for backup types. See the [Development Guide](../development/adding-backup-types.md) for instructions on creating custom backup types.
